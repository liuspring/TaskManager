        ...
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        id = c.Int(nullable: false, identity: true),
                        command_Json = c.String(nullable: false, maxLength: 400, storeType: "nvarchar"),
                        command_Name = c.String(nullable: false, maxLength: 20, storeType: "nvarchar"),
                        command_State = c.Byte(nullable: false),
                ...
                c => new
                    {
                        ...
                        zip_file = c.Binary(),
                        zip_filename = c.String(maxLength: 100, storeType: "nvarchar"),
                        zip_filepath = c.String(maxLength: 200, storeType: "nvarchar"),
                        is_deleted = c.Boolean(nullable: false),
                        deleter_user_id = c.Long(),
                        deletion_time = c.DateTime(precision: 0),
                        last_modification_time = c.DateTime(precision: 0),
