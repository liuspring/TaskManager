...
namespace TaskManager.Node
{
    ...
    public abstract class TaskManagerNodeBase : AbpIntegratedTestBase
    {
        ...
        protected override void AddModules(ITypeList<AbpModule> modules)
        {
            ...
            modules.Add<TaskManagerNodeModule>();
        }
        ...
        protected Task UsingDbContextAsync(Action<TaskManagerDbContext> action)
        {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Action<TaskManagerDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<TaskManagerDbContext>())
