    ...
    public partial class FrmMain : Form
    {
                ...
                foreach (Type myType in types)
                {
                    if (myType.IsClass && myType.BaseType == typeof(Installer))
                    {
                        ...
                        foreach (FieldInfo myFieldInfo in fieldInfos)
                        {
                            ...
                            {
                                var serviceInstaller = (ServiceInstaller)myFieldInfo.GetValue(Activator.CreateInstance(myType));
        ...
        private void btnInstall_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var assemblyInstaller = new AssemblyInstaller(serviceFileName, cmdline);
        ...
        {
            var serviceFileName = (string)e.Argument;
            string[] cmdline = { };
        ...
        private void mBackgroundWorker_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            {
                System.Diagnostics.Process.Start(Assembly.GetExecutingAssembly().Location, txtPath.Text.Trim());
                this.Close();
            }
        }
